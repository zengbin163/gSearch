...
import com.famiao.search.vo.form.Product;
...
//		GetRequest getRequest = new GetRequest("order", id);
		GetRequest getRequest = new GetRequest(null, id);
	...
	public String update(@PathVariable("id") String id, @RequestParam(value = "buyer", required = false) String buyer,
	...
	public Map<String, Object> createOrder(@RequestParam("buyer") String buyer, @RequestParam("date") String date,
		...
		try {
			...
			builder.startObject().field("buyer", buyer).field("date", date).field("totalPrice", total)
					.field("products", list).endObject();
	...
	public List<Map<String, Object>> query(@RequestParam(value = "buyer", required = false) String buyer,
			...
			@RequestParam(value = "status", required = false) Integer status, @RequestParam("index") Integer index,
